  ...
  home-manager.users.herobrine1st = { lib, ... }: with lib.hm.gvariant; {
    dconf.settings = {
      ...
      "org/gnome/desktop/app-folders/folders/6fa7fcc2-aefd-4e1f-827c-cf4a6be704a5" = {
        apps = [ "codium.desktop" "idea-oss.desktop" "pycharm-oss.desktop" "webstorm.desktop" "clion.desktop" "arduino-ide.desktop" "rust-rover.desktop" "android-studio.desktop"  ];
        name = "Development";
        translate = false;
      };
      ...
      "org/gnome/desktop/app-folders/folders/d7db46c4-d38c-4c67-9869-e0e7aa7899c3" = {
        apps = [ "org.gnome.Settings.desktop" "gnome-system-monitor.desktop" "OpenTabletDriver.desktop" "org.gnome.Extensions.desktop" "org.pulseaudio.pavucontrol.desktop" "org.gnome.tweaks.desktop" "nvidia-settings.desktop" "org.gnome.Logs.desktop" "io.github.dp0sk.Crosspipe.desktop" "com.github.wwmm.easyeffects.desktop" "ca.desrt.dconf-editor.desktop" ];
