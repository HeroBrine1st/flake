# Generated by Powerlevel10k configuration wizard on 2025-08-31 at 12:36 UTC.
...
() {
  ...
  # If you want to copy that..
  # WARNING: POWERLEVEL10K IS PATCHED! THIS WON'T WORK WITHOUT PATCH!
  typeset -g POWERLEVEL9K_VCS_STAGED_BACKGROUND=30
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_BACKGROUND=92
  # End of patched behavior
  ...
  function my_git_formatter() {
    ...
    local conflicted='%15F' # white foreground
    ...
    # those two are not documented, looks like duplicated and already swallowed a change indended to lines above!
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean} unknown state (push commits behind), remove on sight:${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+=" ${clean} unknown state (push commits ahead), remove on sight:${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}S:${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}U:${VCS_STATUS_NUM_UNSTAGED}"
  ...
  # TODO cannot be disabled without patch. Disabling that disables showing error code (which is not shown in both cases)
 ...
 ##################################[ context: user@hostname ]##################################
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=15 # #FFFFFF
